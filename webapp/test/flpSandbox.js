		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzfinal2402-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzfinal2402-display": {
								"semanticObject": "iitpzfinal2402",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zfinal2402",
									"url": sap.ui.require.toUrl("iitp/zfinal2402")
								}
							}
						}
					}
